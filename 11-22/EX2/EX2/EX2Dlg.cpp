...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_EDIT1, testEditField);
}
...
BEGIN_MESSAGE_MAP(CEX2Dlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON2, &CEX2Dlg::OnBnClickedButton2)
END_MESSAGE_MAP()
...
BOOL CEX2Dlg::OnInitDialog()
{
	...
	testEditField.SetWindowText(L"Init");
...
void CEX2Dlg::OnBnClickedButton2()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	MessageBox(L"This is button2");
}
